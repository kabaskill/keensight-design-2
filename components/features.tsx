            ...
            >
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">
                      {howWeDo.phases[0].title}
                    </div>
                    <div className="text-gray-600">{howWeDo.phases[0].steps[0]}</div>
                    <div className="text-gray-600">{howWeDo.phases[0].steps[1]}</div>
                    <div className="text-gray-600">{howWeDo.phases[0].steps[2]}</div>
                  </div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">
                      {howWeDo.phases[2].title}
                    </div>
                    <div className="text-gray-600">
                      <div className="text-gray-600">{howWeDo.phases[2].steps[0]}</div>
                      <div className="text-gray-600">{howWeDo.phases[2].steps[1]}</div>
                      <div className="text-gray-600">{howWeDo.phases[2].steps[2]}</div>
                    </div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg
